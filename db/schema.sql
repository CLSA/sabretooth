...
-- Schema sabretooth
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sabretooth` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `cenozo` ;
