...
-- Thu 18 Feb 2016 04:31:33 PM EST
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`qnaire` (
  ...
  INDEX `fk_qnaire_first_attempt_event_type_id_idx` (`first_attempt_event_type_id` ASC),
  INDEX `fk_qnaire_reached_event_type_id_idx` (`reached_event_type_id` ASC),
  INDEX `fk_qnaire_script_id_idx` (`script_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`interview` (
  ...
  INDEX `fk_interview_site_id_idx` (`site_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`assignment` (
  ...
  INDEX `dk_start_datetime` (`start_datetime` ASC),
  INDEX `dk_end_datetime` (`end_datetime` ASC),
  INDEX `fk_assignment_user_id_idx` (`user_id` ASC),
  INDEX `fk_assignment_site_id_idx` (`site_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`phone_call` (
  ...
  INDEX `dk_start_datetime` (`start_datetime` ASC),
  INDEX `dk_end_datetime` (`end_datetime` ASC),
  INDEX `fk_phone_call_phone_id_idx` (`phone_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`shift` (
  ...
  INDEX `dk_start_datetime` (`start_datetime` ASC),
  INDEX `dk_end_datetime` (`end_datetime` ASC),
  INDEX `fk_shift_site_id_idx` (`site_id` ASC),
  INDEX `fk_shift_user_id_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`appointment` (
  ...
  INDEX `fk_interview_id` (`interview_id` ASC),
  INDEX `fk_appointment_phone_id_idx` (`phone_id` ASC),
  INDEX `fk_appointment_user_id_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`shift_template` (
  ...
  INDEX `fk_shift_template_site_id_idx` (`site_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`callback` (
  ...
  INDEX `dk_datetime` (`datetime` ASC),
  INDEX `fk_interview_id` (`interview_id` ASC),
  INDEX `fk_callback_phone_id_idx` (`phone_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`qnaire_has_event_type` (
  ...
  INDEX `fk_qnaire_id` (`qnaire_id` ASC),
  INDEX `fk_qnaire_has_event_type_event_type_id_idx` (`event_type_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`queue_has_participant` (
  ...
  INDEX `fk_queue_id` (`queue_id` ASC),
  INDEX `fk_qnaire_id` (`qnaire_id` ASC),
  INDEX `fk_queue_has_participant_participant_id_idx` (`participant_id` ASC),
  INDEX `fk_queue_has_participant_site_id_idx` (`site_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`qnaire_has_quota` (
  ...
  INDEX `fk_qnaire_id` (`qnaire_id` ASC),
  INDEX `fk_qnaire_has_quota_quota_id_idx` (`quota_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`queue_state` (
  ...
  INDEX `fk_queue_state_site_id_idx` (`site_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`writelog` (
  ...
  PRIMARY KEY (`id`),
  INDEX `dk_datetime` (`datetime` ASC),
  INDEX `fk_writelog_user_id_idx` (`user_id` ASC),
  INDEX `fk_writelog_site_id_idx` (`site_id` ASC),
  INDEX `fk_writelog_role_id_idx` (`role_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sabretooth`.`access` (
  ...
  INDEX `fk_access_site_id_idx` (`site_id` ASC),
