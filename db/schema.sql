...
-- Fri 27 Mar 2015 01:56:05 PM EDT
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sabretooth`.`user_last_activity` (`user_id` INT, `activity_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `sabretooth`.`service_last_activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sabretooth`.`service_last_activity` (`service_id` INT, `activity_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `sabretooth`.`site_last_activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sabretooth`.`site_last_activity` (`site_id` INT, `activity_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `sabretooth`.`role_last_activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sabretooth`.`role_last_activity` (`role_id` INT, `activity_id` INT);
...
-- -----------------------------------------------------
-- View `sabretooth`.`service_last_activity`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `sabretooth`.`service_last_activity` ;
DROP TABLE IF EXISTS `sabretooth`.`service_last_activity`;
USE `sabretooth`;
