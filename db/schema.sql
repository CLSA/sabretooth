...
-- Fri 14 Oct 2016 04:25:26 PM EDT
...
-- -----------------------------------------------------
-- Table `sabretooth`.`export`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sabretooth`.`export` ;

CREATE TABLE IF NOT EXISTS `sabretooth`.`export` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `title` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sabretooth`.`export_column`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sabretooth`.`export_column` ;

CREATE TABLE IF NOT EXISTS `sabretooth`.`export_column` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_export_column_export_id`
    ...
    REFERENCES `sabretooth`.`export` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sabretooth`.`export_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sabretooth`.`export_restriction` ;

CREATE TABLE IF NOT EXISTS `sabretooth`.`export_restriction` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `export_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_export_restriction_export_column_id`
    ...
    REFERENCES `sabretooth`.`export_column` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
