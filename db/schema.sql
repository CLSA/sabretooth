...
-- Tue 05 Dec 2017 11:04:53 AM EST
...
-- -----------------------------------------------------
-- Table `cenozo`.`interview_last_appointment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`interview_last_appointment` ;

CREATE TABLE IF NOT EXISTS `cenozo`.`interview_last_appointment` (
  `interview_id` INT UNSIGNED NOT NULL,
