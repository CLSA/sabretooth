...
CREATE PROCEDURE patch_queue()
  BEGIN
    ...
    IF @test = 22 THEN
      ...
      UPDATE assignment SET queue_id = 32 WHERE queue_id = 33; -- new participant available
      UPDATE assignment SET queue_id = 33 WHERE queue_id = 34; -- new participant always available

      UPDATE assignment SET queue_id = 41 WHERE queue_id = 42; -- contacted available
      UPDATE assignment SET queue_id = 42 WHERE queue_id = 43; -- contacted always available

      UPDATE assignment SET queue_id = 49 WHERE queue_id = 50; -- busy available
      UPDATE assignment SET queue_id = 50 WHERE queue_id = 51; -- busy always available

      UPDATE assignment SET queue_id = 57 WHERE queue_id = 58; -- fax available
      UPDATE assignment SET queue_id = 58 WHERE queue_id = 59; -- fax always available

      UPDATE assignment SET queue_id = 65 WHERE queue_id = 66; -- not reached available
      UPDATE assignment SET queue_id = 66 WHERE queue_id = 67; -- not reached always available

      UPDATE assignment SET queue_id = 73 WHERE queue_id = 74; -- no answer available
      UPDATE assignment SET queue_id = 74 WHERE queue_id = 75; -- no answer always available

      UPDATE assignment SET queue_id = 81 WHERE queue_id = 82; -- machine message available
      UPDATE assignment SET queue_id = 82 WHERE queue_id = 83; -- machine message always available

      UPDATE assignment SET queue_id = 89 WHERE queue_id = 90; -- machine no message available
      UPDATE assignment SET queue_id = 90 WHERE queue_id = 91; -- machine no message always available

      UPDATE assignment SET queue_id = 97 WHERE queue_id = 98; -- hang up available
      UPDATE assignment SET queue_id = 98 WHERE queue_id = 99; -- hang up always available

      UPDATE assignment SET queue_id = 105 WHERE queue_id = 106; -- soft refusal available
      UPDATE assignment SET queue_id = 106 WHERE queue_id = 107; -- soft refusal always available
