    ...
    SET @sql = CONCAT(
      ...
      "AND service.id NOT IN ( ",
        ...
        "WHERE subject IN( ",
          ...
          "'event', 'event_type', 'export', 'export_column', 'export_restriction', 'form', 'hin', 'interview', ",
          "'jurisdiction', 'language', 'phase', 'phone', 'qnaire', 'quota', 'recording', 'recording_file', ",
          "'region_site', 'report_schedule', 'script', 'source', 'state' ) ",
