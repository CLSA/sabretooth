...
CREATE PROCEDURE patch_queue()
  BEGIN
    ...
    IF @test = 106 THEN
      ...
      UPDATE assignment SET queue_id = 19 WHERE queue_id = 18;
      UPDATE assignment SET queue_id = 18 WHERE queue_id = 17;
      UPDATE assignment SET queue_id = 17 WHERE queue_id = 16;
