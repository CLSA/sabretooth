...
INSERT INTO role_has_operation
SET role_id = ( SELECT id FROM cenozo.role WHERE name = "opal" ),
    operation_id = ( SELECT id FROM operation WHERE
...
-- setting
INSERT INTO role_has_operation
SET role_id = ( SELECT id FROM cenozo.role WHERE name = "supervisor" ),
    operation_id = ( SELECT id FROM operation WHERE
...
SET role_id = ( SELECT id FROM role WHERE name = "supervisor" ),
    operation_id = ( SELECT id FROM operation WHERE
      type = "widget" AND subject = "callback" AND name = "report" );
INSERT INTO role_has_operation
SET role_id = ( SELECT id FROM role WHERE name = "supervisor" ),
    operation_id = ( SELECT id FROM operation WHERE
      type = "pull" AND subject = "callback" AND name = "report" );
...
-- consent
INSERT INTO role_has_operation
SET role_id = ( SELECT id FROM cenozo.role WHERE name = "typist" ),
    operation_id = ( SELECT id FROM operation WHERE
      type = "push" AND subject = "consent" AND name = "new" );
