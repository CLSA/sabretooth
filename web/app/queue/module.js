        ...
        var object = function (parentModel, root) {
          ...
          async function init(object) {
            ...
            if (angular.isDefined(object.participantModel)) {
              ...
              object.participantModel.getServiceData = function (
                type,
                columnRestrictList
              ) {
          ...
          angular.extend(this, {
            ...
            onView: async function (updateQueue) {
              ...
              if (0 == this.form.siteList.length && CnSession.role.allSites) {
                ...
                response.data.forEach((item) => {
                  this.form.siteList.push({ value: item.id, name: item.name });
                });
              }
