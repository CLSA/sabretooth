...
jQuery(document).ready( function() {
  var sabretooth_pull_url = "../sabretooth/service/";
  $question = $( "div[id^=question]" )
  if( $question && $question.html() ) {
    jQuery.getJSON( sabretooth_pull_url + "self/primary",
                    function( json ) {
      if( json.success ) {
    ...
    jQuery.getJSON( sabretooth_pull_url + "participant/primary?id=assignment",
                    function( json ) {
      if( json.success ) {
