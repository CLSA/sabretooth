...
/**
 * widget cedar_instance list
 */
class cedar_instance_list extends \cenozo\ui\widget\base_list
{
  /**
   * Constructor
   * 
   * Defines all variables required by the cedar_instance list.
   * @author Patrick Emond <emondpd@mcmaster.ca>
