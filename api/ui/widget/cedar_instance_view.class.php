...
/**
 * widget cedar_instance view
 */
class cedar_instance_view extends \cenozo\ui\widget\base_view
{
  /**
   * Constructor
   * 
  ...
  {
    parent::__construct( 'cedar_instance', 'view', $args );
  }
