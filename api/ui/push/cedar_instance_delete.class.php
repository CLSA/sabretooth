<?php
/**
 * cedar_instance_delete.class.php
 * 
...
/**
 * push: cedar_instance delete
 */
class cedar_instance_delete extends \cenozo\ui\push\base_delete
{
  /**
   * Constructor.
   * @author Patrick Emond <emondpd@mcmaster.ca>
  ...
  protected function validate()
  {
    ...
    if( 1 < count( $this->get_record()->get_user()->get_access_count() ) )
      throw lib::create( 'exception\notice',
        'Cannot delete the cedar instance since it holds more than one role.', __METHOD__ );
  }
