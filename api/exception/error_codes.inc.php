...
define( 'NOTICE_QNAIRE_NEW__EXECUTE_ERROR_NUMBER',              NOTICE_BASE_ERROR_NUMBER + 7 );
define( 'NOTICE_AVAILABILITY_EDIT__EXECUTE_ERROR_NUMBER',       NOTICE_BASE_ERROR_NUMBER + 8 );
define( 'NOTICE_AVAILABILITY_NEW__EXECUTE_ERROR_NUMBER',        NOTICE_BASE_ERROR_NUMBER + 9 );
define( 'NOTICE_SHIFT_NEW__EXECUTE_ERROR_NUMBER',               NOTICE_BASE_ERROR_NUMBER + 10 );
define( 'NOTICE_SHIFT_EDIT__EXECUTE_ERROR_NUMBER',              NOTICE_BASE_ERROR_NUMBER + 11 );
define( 'NOTICE_APPOINTMENT_NEW__EXECUTE_ERROR_NUMBER',         NOTICE_BASE_ERROR_NUMBER + 12 );
define( 'NOTICE_ASSIGNMENT_BEGIN__EXECUTE_ERROR_NUMBER',        NOTICE_BASE_ERROR_NUMBER + 13 );
define( 'NOTICE_ASSIGNMENT_END__EXECUTE_ERROR_NUMBER',          NOTICE_BASE_ERROR_NUMBER + 14 );
define( 'NOTICE_VOIP_MANAGER__CALL_ERROR_NUMBER',               NOTICE_BASE_ERROR_NUMBER + 15 );
define( 'NOTICE_ADDRESS_NEW__EXECUTE_ERROR_NUMBER',             NOTICE_BASE_ERROR_NUMBER + 16 );
define( 'NOTICE_ADDRESS_EDIT__EXECUTE_ERROR_NUMBER',            NOTICE_BASE_ERROR_NUMBER + 17 );
define( 'NOTICE_APPOINTMENT_EDIT__EXECUTE_ERROR_NUMBER',        NOTICE_BASE_ERROR_NUMBER + 18 );
define( 'NOTICE_SELF_SET_PASSWORD__EXECUTE_ERROR_NUMBER',       NOTICE_BASE_ERROR_NUMBER + 19 );
define( 'NOTICE_PHONE_NEW__EXECUTE_ERROR_NUMBER',               NOTICE_BASE_ERROR_NUMBER + 20 );
define( 'NOTICE_PHONE_EDIT__EXECUTE_ERROR_NUMBER',              NOTICE_BASE_ERROR_NUMBER + 20 );
...
define( 'RUNTIME_ADDRESS_ADD__FINISH_ERROR_NUMBER',              RUNTIME_BASE_ERROR_NUMBER + 15 );
...
define( 'RUNTIME_PARTICIPANT__ADD_RECORDS_ERROR_NUMBER',         RUNTIME_BASE_ERROR_NUMBER + 24 );
define( 'RUNTIME_PARTICIPANT__REMOVE_RECORDS_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 25 );
define( 'RUNTIME_ASSIGNMENT_BEGIN__EXECUTE_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 26 );
define( 'RUNTIME_PHONE_CALL_BEING__EXECUTE_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 27 );
define( 'RUNTIME_VOIP_MANAGER__INITIALIZE_ERROR_NUMBER',         RUNTIME_BASE_ERROR_NUMBER + 28 );
define( 'RUNTIME_VOIP_MANAGER__CONNECT_ERROR_NUMBER',            RUNTIME_BASE_ERROR_NUMBER + 29 );
define( 'RUNTIME_VOIP_MANAGER__CALL_ERROR_NUMBER',               RUNTIME_BASE_ERROR_NUMBER + 30 );
define( 'RUNTIME_PARTICIPANT_PRIMARY____CONSTRUCT_ERROR_NUMBER', RUNTIME_BASE_ERROR_NUMBER + 31 );
define( 'RUNTIME_NOTE_LIST__FINISH_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 32 );
define( 'RUNTIME_NOTE_NEW__EXECUTE_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 33 );
define( 'RUNTIME_APPOINTMENT__VALIDATE_DATE_ERROR_NUMBER',       RUNTIME_BASE_ERROR_NUMBER + 34 );
define( 'RUNTIME_AUTOLOADER__AUTOLOAD_ERROR_NUMBER',             RUNTIME_BASE_ERROR_NUMBER + 35 );
define( 'RUNTIME_LDAP_MANAGER__SET_USER_PASSWORD_ERROR_NUMBER',  RUNTIME_BASE_ERROR_NUMBER + 36 );
define( 'RUNTIME_LDAP_MANAGER__VALIDATE_USER_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 37 );
define( 'RUNTIME_SESSION__VALIDATE_PASSWORD_ERROR_NUMBER',       RUNTIME_BASE_ERROR_NUMBER + 38 );
define( 'RUNTIME_APPOINTMENT__SAVE_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 39 );
define( 'RUNTIME_HAS_RANK____CONSTRUCT_ERROR_NUMBER',            RUNTIME_BASE_ERROR_NUMBER + 40 );
define( 'RUNTIME_PHONE_ADD__FINISH_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 41 );
define( 'RUNTIME_REPORT__SET_CELL_ERROR_NUMBER',                 RUNTIME_BASE_ERROR_NUMBER + 42 );
define( 'RUNTIME_REPORT____CALL_ERROR_NUMBER',                   RUNTIME_BASE_ERROR_NUMBER + 43 );
