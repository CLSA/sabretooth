...
define( 'RUNTIME_SELF_SET_ROLE__EXECUTE_ERROR_NUMBER',           RUNTIME_BASE_ERROR_NUMBER + 6 );
define( 'RUNTIME_SELF_SET_SITE__EXECUTE_ERROR_NUMBER',           RUNTIME_BASE_ERROR_NUMBER + 7 );
define( 'RUNTIME_LOG__INITIALIZE_LOGGER_ERROR_NUMBER',           RUNTIME_BASE_ERROR_NUMBER + 8 );
define( 'RUNTIME_BASE_VIEW__SET_ITEM_ERROR_NUMBER',              RUNTIME_BASE_ERROR_NUMBER + 9 );
define( 'RUNTIME_AVAILABILITY__ADD_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 10 );
define( 'RUNTIME_CONTACT_ADD__FINISH_ERROR_NUMBER',              RUNTIME_BASE_ERROR_NUMBER + 11 );
define( 'RUNTIME_PHASE_ADD__FINISH_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 12 );
define( 'RUNTIME_SHIFT_ADD__FINISH_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 13 );
define( 'RUNTIME_CONSENT_ADD__FINISH_ERROR_NUMBER',              RUNTIME_BASE_ERROR_NUMBER + 14 );
define( 'RUNTIME_DATABASE____CONSTRUCT_ERROR_NUMBER',            RUNTIME_BASE_ERROR_NUMBER + 15 );
define( 'RUNTIME_DATABASE__GET_COLUMN_NAMES_ERROR_NUMBER',       RUNTIME_BASE_ERROR_NUMBER + 16 );
define( 'RUNTIME_DATABASE__GET_COLUMN_TYPE_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 17 );
define( 'RUNTIME_SHIFT__SAVE_ERROR_NUMBER',                      RUNTIME_BASE_ERROR_NUMBER + 18 );
define( 'RUNTIME_APPOINTMENT_ADD__FINISH_ERROR_NUMBER',          RUNTIME_BASE_ERROR_NUMBER + 19 );
define( 'RUNTIME_SAMPLE__SAVE_ERROR_NUMBER',                     RUNTIME_BASE_ERROR_NUMBER + 10 );
define( 'RUNTIME_PARTICIPANT__ADD_RECORDS_ERROR_NUMBER',         RUNTIME_BASE_ERROR_NUMBER + 21 );
define( 'RUNTIME_PARTICIPANT__REMOVE_RECORDS_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 22 );
define( 'RUNTIME_SAMPLE__ADD_RECORDS_ERROR_NUMBER',              RUNTIME_BASE_ERROR_NUMBER + 23 );
define( 'RUNTIME_SAMPLE__REMOVE_RECORDS_ERROR_NUMBER',           RUNTIME_BASE_ERROR_NUMBER + 24 );
define( 'RUNTIME_OPERATOR_NEW_ASSIGNMENT__EXECUTE_ERROR_NUMBER', RUNTIME_BASE_ERROR_NUMBER + 25 );
