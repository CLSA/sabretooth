 ...
 * TODO: separate class and method by two underscores, for clarity
...
define( 'ARGUMENT_ACTIVE_RECORD_GET_ENUM_VALUES_ERROR_NUMBER', ARGUMENT_BASE_ERROR_NUMBER + 8 );
define( 'ARGUMENT_BASE_DELETE___CONSTRUCT_ERROR_NUMBER',       ARGUMENT_BASE_ERROR_NUMBER + 9 );
define( 'ARGUMENT_BASE_EDIT___CONSTRUCT_ERROR_NUMBER',         ARGUMENT_BASE_ERROR_NUMBER + 10 );
define( 'ARGUMENT_BASE_RECORD_SET_MODE_ERROR_NUMBER',          ARGUMENT_BASE_ERROR_NUMBER + 11 );
define( 'ARGUMENT_OPERATION_GET_ARGUMENT_ERROR_NUMBER',        ARGUMENT_BASE_ERROR_NUMBER + 12 );
define( 'ARGUMENT_WIDGET_GET_ARGUMENT_ERROR_NUMBER',           ARGUMENT_BASE_ERROR_NUMBER + 13 );
define( 'ARGUMENT_WIDGET_SCRIPT_ERROR_NUMBER',                 ARGUMENT_BASE_ERROR_NUMBER + 14 );
define( 'ARGUMENT_ACTION_SCRIPT_ERROR_NUMBER',                 ARGUMENT_BASE_ERROR_NUMBER + 15 );
define( 'ARGUMENT_SESSION___CONSTRUCT_ERROR_NUMBER',           ARGUMENT_BASE_ERROR_NUMBER + 16 );
define( 'ARGUMENT_OPERATION___CONSTRUCT_ERROR_NUMBER',         ARGUMENT_BASE_ERROR_NUMBER + 17 );
define( 'ARGUMENT_SITE_ADD_ACCESS_ERROR_NUMBER',               ARGUMENT_BASE_ERROR_NUMBER + 18 );
define( 'ARGUMENT_BASE_VIEW_SET_ITEM_ACCESS_ERROR_NUMBER',     ARGUMENT_BASE_ERROR_NUMBER + 19 );
define( 'ARGUMENT_BASE_VIEW_ADD_ITEM_ACCESS_ERROR_NUMBER',     ARGUMENT_BASE_ERROR_NUMBER + 20 );
...
define( 'NOTICE_PARTICIPANT_NEW_EXECUTE_ERROR_NUMBER',   NOTICE_BASE_ERROR_NUMBER + 6 );
define( 'NOTICE_SAMPLE_NEW_EXECUTE_ERROR_NUMBER',        NOTICE_BASE_ERROR_NUMBER + 7 );
define( 'NOTICE_QNAIRE_NEW_EXECUTE_ERROR_NUMBER',        NOTICE_BASE_ERROR_NUMBER + 8 );
define( 'NOTICE_AVAILABILITY_EDIT_EXECUTE_ERROR_NUMBER', NOTICE_BASE_ERROR_NUMBER + 9 );
define( 'NOTICE_AVAILABILITY_NEW_EXECUTE_ERROR_NUMBER',  NOTICE_BASE_ERROR_NUMBER + 10 );
...
define( 'RUNTIME_PHASE_ADD_FINISH_ERROR_NUMBER',          RUNTIME_BASE_ERROR_NUMBER + 10 );
define( 'RUNTIME_BASE_VIEW_SET_ITEM_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 11 );
