...
define( 'NOTICE__SABRETOOTH_UI_PULL_PARTICIPANT_SYNC__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 3 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_ADDRESS_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 4 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_ADDRESS_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 5 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_APPOINTMENT_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 6 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_APPOINTMENT_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 7 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_ASSIGNMENT_BEGIN__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 8 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_ASSIGNMENT_END__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 9 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_CONSENT_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 10 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_INTERVIEW_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 11 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_PARTICIPANT_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 12 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_PHONE_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 13 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_PHONE_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 14 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_QNAIRE_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 15 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_QUEUE_RESTRICTION_DELETE__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 16 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_QUEUE_RESTRICTION_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 17 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_QUEUE_RESTRICTION_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 18 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_SHIFT_EDIT__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 19 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_SHIFT_NEW__FINISH__ERRNO',
        NOTICE_SABRETOOTH_BASE_ERRNO + 20 );
define( 'NOTICE__SABRETOOTH_UI_PUSH_VOIP_DTMF__FINISH__ERRNO',
...
define( 'RUNTIME__SABRETOOTH_UI_PULL_PARTICIPANT_PRIMARY____CONSTRUCT__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 14 );
define( 'RUNTIME__SABRETOOTH_UI_PUSH_PARTICIPANT_WITHDRAW__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 15 );
define( 'RUNTIME__SABRETOOTH_UI_PUSH_PHONE_CALL_BEGIN__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 16 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_ADDRESS_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 17 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_APPOINTMENT_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 18 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_AVAILABILITY_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 19 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_CONSENT_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 20 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_PHASE_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 21 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_PHONE_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 22 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_SOURCE_SURVEY_ADD__FINISH__ERRNO',
        RUNTIME_SABRETOOTH_BASE_ERRNO + 23 );
define( 'RUNTIME__SABRETOOTH_UI_WIDGET_SOURCE_WITHDRAW_ADD__FINISH__ERRNO',
