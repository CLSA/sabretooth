...
define( 'ARGUMENT_ACTIVE_RECORD____GET_ERROR_NUMBER',           ARGUMENT_BASE_ERROR_NUMBER + 5 );
define( 'ARGUMENT_ACTIVE_RECORD____SET_ERROR_NUMBER',           ARGUMENT_BASE_ERROR_NUMBER + 6 );
define( 'ARGUMENT_ACTIVE_RECORD____CALL_ERROR_NUMBER',          ARGUMENT_BASE_ERROR_NUMBER + 7 );
define( 'ARGUMENT_ACTIVE_RECORD__GET_ENUM_VALUES_ERROR_NUMBER', ARGUMENT_BASE_ERROR_NUMBER + 8 );
 ...
 * "runtime" error codes
 */
define( 'RUNTIME_ACTIVE_RECORD____CONSTRUCT_ERROR_NUMBER', RUNTIME_BASE_ERROR_NUMBER + 1 );
define( 'RUNTIME_ACTIVE_RECORD____CALL_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 2 );
define( 'RUNTIME_ACTIVE_RECORD__LOAD_ERROR_NUMBER',        RUNTIME_BASE_ERROR_NUMBER + 3 );
