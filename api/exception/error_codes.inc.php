...
define( 'RUNTIME_APPOINTMENT_ADD__FINISH_ERROR_NUMBER',     RUNTIME_BASE_ERROR_NUMBER + 18 );
define( 'RUNTIME_SAMPLE__SAVE_ERROR_NUMBER',                RUNTIME_BASE_ERROR_NUMBER + 19 );
define( 'RUNTIME_PARTICIPANT__ADD_RECORDS_ERROR_NUMBER',    RUNTIME_BASE_ERROR_NUMBER + 20 );
define( 'RUNTIME_PARTICIPANT__REMOVE_RECORDS_ERROR_NUMBER', RUNTIME_BASE_ERROR_NUMBER + 21 );
define( 'RUNTIME_SAMPLE__ADD_RECORDS_ERROR_NUMBER',         RUNTIME_BASE_ERROR_NUMBER + 22 );
define( 'RUNTIME_SAMPLE__REMOVE_RECORDS_ERROR_NUMBER',      RUNTIME_BASE_ERROR_NUMBER + 23 );
